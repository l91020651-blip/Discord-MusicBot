module.exports = {
	...
	disconnectTime: 30000000, //- How long should the bot wait before disconnecting from the voice channel (in miliseconds). Set to 1 for instant disconnect.
	...
	nodes: [
		{
			identifier: "Public Node v3", //- Used for indentifier in stats commands.
			host: "lavalinkv3.serenetia.com", //- The host name or IP of the lavalink server.
